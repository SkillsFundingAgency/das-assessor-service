...
{
    public class QualificationDetailsResolver : IValueResolver<FrameworkLearner, GetFrameworkLearnerResponse, List<QualificationDetails>>
    {
        public List<QualificationDetails> Resolve(FrameworkLearner source, GetFrameworkLearnerResponse destination, List<QualificationDetails> destMember, ResolutionContext context)
        {
