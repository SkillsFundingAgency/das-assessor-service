...
namespace SFA.DAS.AssessorService.Application.Interfaces
{
    public interface IRegisterRepository
    {
        ...
        Task<string> UpdateEpaOrganisationStandardAndOrganisationStandardVersions(EpaOrganisationStandard organisationStandard, List<int> deliveryAreas, bool applyFollowingWithdrawal = false);
