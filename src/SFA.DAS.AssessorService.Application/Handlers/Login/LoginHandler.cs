...
namespace SFA.DAS.AssessorService.Application.Handlers.Login
{
    public class LoginHandler : IRequestHandler<LoginRequest, LoginResponse>
    {
        ...
        public async Task<LoginResponse> Handle(LoginRequest request, CancellationToken cancellationToken)
        {
            ...
            var contact = await _contactQueryRepository.GetContactByGovIdentifier(request.GovUkIdentifier);
            ...
            if (contact != null)
            {
                ...
                else
                {
                    ...
                    var status = contact.Status; //await GetUserStatus(organisation.EndPointAssessorOrganisationId, request.GovUkIdentifier);
                    switch (status)
                    {
        ...
        private async Task CheckAndSetPrivileges(Contact existingContact)
        {
            ...
            {
                var orgHasContacts = await _organisationQueryRepository.CheckIfOrganisationHasContactsWithGovUkIdentifier(existingContact
