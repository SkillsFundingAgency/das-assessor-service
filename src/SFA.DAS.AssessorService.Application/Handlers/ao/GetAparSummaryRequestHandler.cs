...
{
    public class GetAparSummaryRequestHandler : IRequestHandler<GetAparSummaryRequest, List<AparSummaryItem>>
    {
        ...
        public async Task<List<AparSummaryItem>> Handle(GetAparSummaryRequest request, CancellationToken cancellationToken)
        {
