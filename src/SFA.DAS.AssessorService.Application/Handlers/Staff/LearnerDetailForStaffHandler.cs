...
{
    public class LearnerDetailForStaffHandler : IRequestHandler<LearnerDetailForStaffRequest, LearnerDetailForStaff>
    {
        private readonly IIlrRepository _ilrRepository;
        private readonly ICertificateRepository _certificateRepository;
        private readonly IStaffCertificateRepository _staffCertificateRepository;
        private readonly ILogger<LearnerDetailForStaffHandler> _logger;
        private readonly IOrganisationQueryRepository _organisationRepository;
        private readonly IStandardRepository _standardRepository;

        public LearnerDetailForStaffHandler(IIlrRepository ilrRepository, ICertificateRepository certificateRepository, 
            IStaffCertificateRepository staffCertificateRepository, ILogger<LearnerDetailForStaffHandler> logger, IOrganisationQueryRepository organisationRepository, IStandardRepository standardRepository)
        {
        ...
        public async Task<LearnerDetailForStaff> Handle(LearnerDetailForStaffRequest request, CancellationToken cancellationToken)
        {
            ...
            var learnerDetail = new LearnerDetailForStaff()
            {
                Uln = request.Uln,
