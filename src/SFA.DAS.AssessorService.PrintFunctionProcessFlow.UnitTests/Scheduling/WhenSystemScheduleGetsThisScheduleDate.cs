...
{
    [TestClass]
    public class WhenSystemScheduleGetsThisScheduleDate
    {       
        [TestMethod]
        public void GetThisDateForSystemSucessfullyRunsOnThe14thAndTodaysDateIsThe21st()
        {
            var scheduledDateTime = new DateTime(2018, 05, 14);

            var nextDate = new ScheduledDates().GetThisScheduledDate(new DateTime(2018, 05, 21), new DateTime(2018, 05, 14));

            nextDate.Date.Should().Be(new DateTime(2018, 05, 21));
        }

        [TestMethod]
        public void GetThisDateForSystemSucessfullyRunsOnThe14thAndTodaysDateIsThe22nd()
        {
            var scheduledDateTime = new DateTime(2018, 05, 14);

            var nextDate = new ScheduledDates().GetThisScheduledDate(new DateTime(2018, 05, 22), new DateTime(2018, 05, 14));

            nextDate.Date.Should().Be(new DateTime(2018, 05, 21));
        }

        [TestMethod]
        public void GetThisDateForSystemSucessfullyRunsOnThe14thAndTodaysDateIsThe26th()
        {
            var scheduledDateTime = new DateTime(2018, 05, 14);
        ...
        [TestMethod]
        public void GetThisDateForSystemSucessfullyRunsOnThe14thAndTodaysDateIsThe28th()
        {
            var scheduledDateTime = new DateTime(2018, 05, 14);

            var nextDate = new ScheduledDates().GetThisScheduledDate(new DateTime(2018, 05, 28), new DateTime(2018, 05, 14));

            nextDate.Date.Should().Be(new DateTime(2018, 05, 28));
        }

        [TestMethod]
        public void GetThisDateForSystemSucessfullyRunsOnThe14thAndTodaysDateIsThe29th()
        {
            var scheduledDateTime = new DateTime(2018, 05, 14);

            var nextDate = new ScheduledDates().GetThisScheduledDate(new DateTime(2018, 05, 29), new DateTime(2018, 05, 14));

            nextDate.Date.Should().Be(new DateTime(2018, 05, 28));
        }

        //[TestMethod]
        //public void GetThisDateForSystemSucessfullyRunsOnThe14thAndTodaysDateIsThe15th()
        //{
        //    var scheduledDateTime = new DateTime(2018, 05, 14);
