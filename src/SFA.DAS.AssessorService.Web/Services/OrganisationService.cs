...
namespace SFA.DAS.AssessorService.Web.Services
{
    public class OrganisationService : IOrganisationService
    {
        ...
        public OrganisationService(IHttpClient httpClient)
        {
            ...
            _remoteServiceBaseUrl = $"{apiServiceHost}/api/v1/Organisation";
        }

        public async Task<Organisation> GetOrganisation(string token)
        {
            var apiUri = ApiUriGenerator.Organisation.GetOrganisation(_remoteServiceBaseUrl);
