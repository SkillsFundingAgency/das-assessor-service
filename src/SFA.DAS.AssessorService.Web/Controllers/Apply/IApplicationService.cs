...
namespace SFA.DAS.AssessorService.Web.Controllers.Apply
{
    ...
    {
        Task<CreateApplicationRequest> BuildStandardWithdrawalRequest(ContactResponse contact, OrganisationResponse organisation, int standardCode, string referenceFormat, string standardOrVersion);
