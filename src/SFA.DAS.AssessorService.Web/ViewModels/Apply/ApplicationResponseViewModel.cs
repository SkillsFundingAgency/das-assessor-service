...
namespace SFA.DAS.AssessorService.Web.ViewModels.Apply
{
    public class ApplicationResponseViewModel
    {
        ...
        public string ApplicationPostAction()
        {
            return FinancialInfoStage1Expired
                ? nameof(ApplicationController.FinancialExpiredRedir)
                : nameof(ApplicationController.StartApplication);
        }
    }
}
