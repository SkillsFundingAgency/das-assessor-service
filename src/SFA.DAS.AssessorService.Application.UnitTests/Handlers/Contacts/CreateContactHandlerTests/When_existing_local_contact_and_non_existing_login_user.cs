...
{
    public class When_existing_local_contact_and_non_existing_login_user : CreateContactsHandlerTestBase
    {
        ...
        public async Task Then_local_contact_is_not_updated_with_signInId()
        {
            ...
            ContactRepository.Verify(r => r.UpdateSignInId(_existingContactUserId, _existingLoginUserId, null), Times.Never);
        }
    }
}