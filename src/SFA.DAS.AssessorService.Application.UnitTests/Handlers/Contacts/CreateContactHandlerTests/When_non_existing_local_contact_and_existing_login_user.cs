...
{
    public class When_non_existing_local_contact_and_existing_login_user : CreateContactsHandlerTestBase
    {
        ...
        public async Task Then_local_contact_is_updated_with_signInId()
        {
            ...
            ContactRepository.Verify(r => r.UpdateSignInId(_newContactId, _existingLoginUserId, null));
        }
    }
}