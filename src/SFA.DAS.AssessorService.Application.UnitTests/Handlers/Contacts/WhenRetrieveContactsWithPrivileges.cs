...
//            var getContactsRequest = new GetContactsWithPrivilegesRequest("organisationId");
//            var retrieveContactsHandler = new GetContactsWithPrivilegesHandler(contactQueryRepositoryMock.Object);
