...
namespace SFA.DAS.AssessorService.Application.UnitTests.Handlers.Standards.GetEpaoPipelineStandardsHandlerTests
{
    ...
    public class When_called
    {
        ...
        public async Task Then_number_of_epaos_in_pipeline_are_returned(string epaoId, int count)
        {
            ...
            _mockRepository
                .Setup(r => r.GetEpaoPipelineStandards(epaoId, It.IsAny<string>(), It.IsAny<string>(),
                It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int?>(), It.IsAny<int>()))
            ...
            // Assert
            _mockRepository
                .Verify(r => r.GetEpaoPipelineStandards(epaoId, It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int?>(), 6), Times.Once);
