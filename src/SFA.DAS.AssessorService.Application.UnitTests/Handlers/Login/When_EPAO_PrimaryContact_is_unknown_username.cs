...
{
    [TestFixture]
    public class When_EPAO_PrimaryContact_is_unknown_username : LoginHandlerTestsBase
    {
        [Test]
        public void Then_Epao_PrimaryContact_is_Updated()
        {
            ...
            ContactQueryRepository.Setup(r => r.GetContact("unknown")).ReturnsAsync(default(Contact));
