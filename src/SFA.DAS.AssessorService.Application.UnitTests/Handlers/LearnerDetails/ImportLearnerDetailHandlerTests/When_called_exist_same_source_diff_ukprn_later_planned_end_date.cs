...
{
    [TestFixture]
    public class When_called_exist_same_source_diff_ukprn_later_planned_end_date : ImportLearnerDetailHandlerTestsBase
    {
        [SetUp]
        public void Arrange()
        {
            ...
            ImportLearnerDetail.PlannedEndDate = ImportLearnerDetail.PlannedEndDate.Value.AddDays(10);
