...
{
    [TestFixture]
    public class When_called_exist_same_source_diff_ukprn_with_draft_certificate_and_later_planned_end_date : ImportLearnerDetailHandlerTestsBase
    {
        [SetUp]
        public void Arrange()
        {
        ...
        [Test]
        public async Task Then_an_existing_learner_record_is_updated()
        {
            // Act
            Response = await Sut.Handle(Request, new CancellationToken());
