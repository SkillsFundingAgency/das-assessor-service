...
namespace SFA.DAS.AssessorService.Application.UnitTests.Handlers.Search
{
    ...
    public class When_returned_learners_match_users_epaorgid 
    {
        ...
        public void SetUp()
        {
            ...
            _ilrRepository.Setup(r => r.SearchForLearnerByUlnAndFamilyName(It.IsAny<long>(), It.IsAny<string>()))
                .ReturnsAsync(new List<Ilr>
                {
                    ...
                    new Ilr
                    {
                        Uln = 1111111111, EpaOrgId = "EPA0001", StdCode = 2, FamilyName = "James",
                        CompletionStatus = CompletionStatus.Completed
                    },
                    new Ilr
                    {
        ...
        public void Then_those_learners_are_returned()
        {
            ...
            _organisationRepository.Setup(r => r.GetByUkPrn(12345)).ReturnsAsync(new Organisation() { EndPointAssessorOrganisationId = "EPA0001"});
 
            
            var handler = new SearchHandler(_assessmentOrgsApiClient.Object,
                _organisationRepository.Object, _ilrRepository.Object,
                _certificateRepository.Object, new Mock<ILogger<SearchHandler>>().Object,_contactRepository.Object, _providerEventsApiClientMock.Object);
