...
namespace SFA.DAS.AssessorService.Application.UnitTests.Handlers.Search
{
    ...
    public class When_certificate_exists_with_no_learner_record : SearchHandlerTestBase
    {
        ...
        public void Then_search_result_is_returned()
        {
            ...
            var result = SearchHandler.Handle(new CertificateSearchRequest { Surname = "Lamora", EpaOrgId = "12345", Uln = 1111111111, Username = "username" }, CancellationToken.None).Result;
        ...
        public void and_learnername_does_not_match_then_search_result_is_not_returned()
        {
            ...
            var result = SearchHandler.Handle(new CertificateSearchRequest { Surname = "UnknownName", EpaOrgId = "12345", Uln = 1111111111, Username = "username" }, CancellationToken.None).Result;
