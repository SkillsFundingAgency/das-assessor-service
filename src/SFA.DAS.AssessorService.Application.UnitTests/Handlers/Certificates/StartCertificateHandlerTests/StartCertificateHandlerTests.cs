...
namespace SFA.DAS.AssessorService.Application.UnitTests.Handlers.Certificates.StartCertificateHandlerTests
{
    public class StartCertificateHandlerTests
    {
            ...
            CertificateData certificateData)
        {
            ...
            _mockCertificateRepository.Verify(s => s.Update(existingCertificate, request.Username, CertificateActions.StartRetake, true, "Retake failed apprenticeship"), Times.Once);
        }
