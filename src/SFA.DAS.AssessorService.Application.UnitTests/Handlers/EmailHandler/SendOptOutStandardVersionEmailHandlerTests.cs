...
{
    [TestFixture]
    public class SendOptOutStandardVersionEmailHandlerTests
    {
        ...
        private Mock<ILogger<SendOptOutStandardVersionEmailHandler>> _loggerMock;
        private SendOptOutStandardVersionEmailHandler _handler;
        ...
        public void SetUp()
        {
            ...
            _loggerMock = new Mock<ILogger<SendOptOutStandardVersionEmailHandler>>();

            _handler = new SendOptOutStandardVersionEmailHandler(
        ...
        {
            // Arrange
            var request = new SendOptOutStandardVersionEmailRequest { ContactId = Guid.NewGuid(), StandardReference = "ST0001", Version = "1.0" };
            ...
            var emailTemplateSummary = new EmailTemplateSummary { TemplateName = EmailTemplateNames.EPAOStandardConfimOptOut };
            ...
            _emailTemplateQueryRepositoryMock.Setup(x => x.GetEmailTemplate(EmailTemplateNames.EPAOStandardConfimOptOut)).ReturnsAsync(emailTemplateSummary);
