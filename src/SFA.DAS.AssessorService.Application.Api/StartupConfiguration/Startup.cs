    ...
    public class Startup
    {
        ...
        private IServiceProvider ConfigureIOC(IServiceCollection services)
        {
            ...
            container.Configure(config =>
            {
                ...
                config.For<ISubmissionEventProviderApiClient>().Use( () => new SubmissionEventProviderApiClient(Configuration.ProviderEventsClientConfiguration.ApiBaseUrl,
                    Configuration.ProviderEventsClientConfiguration.ClientToken,
                    Configuration.ProviderEventsClientConfiguration.ApiVersion));
