...
namespace SFA.DAS.AssessorService.Application.Api.AutoMapperProfiles
{
    public class UkrlpOrganisationProfile : Profile
    {
        ...
        {
            CreateMap<AssessorService.Api.Types.Models.UKRLP.ProviderDetails, OrganisationSearchResult>()
                ...
                .ForMember(dest => dest.Address, opt => opt.ResolveUsing(source => Mapper.Map<AssessorService.Api.Types.Models.UKRLP.ContactAddress, OrganisationAddress>(source.ContactDetails?.Select(cd => cd.ContactAddress).FirstOrDefault(address => address != null))))
    ...
    public class UkrlpOrganisationAddressProfile : Profile
    {
        ...
        {
            CreateMap<AssessorService.Api.Types.Models.UKRLP.ContactAddress, OrganisationAddress>()
