    ...
    public class StandardService : IStandardService
    {
        ...
        public async Task<Standard> GetStandardVersionById(string id, string version = null)
        {
            ...
            try
            {
                ...
                if (standard == null)
                {
                    _logger.LogInformation($"Unable to find standard for Id: {id}, version: {version} and standard id type: {standardId.IdType}");
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<StandardOptions> GetStandardOptionsByStandardId(string id)
        {
            ...
            try
            {
                ...
                if (options == null)
                {
                    _logger.LogInformation($"Unable to find standard options for id: {id} and standard id type: {standardId.IdType}");
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<StandardOptions> GetStandardOptionsByStandardIdAndVersion(string id, string version)
        {
            ...
            try
            {
                ...
                if (standard == null)
                {
                    _logger.LogInformation($"Unable to find standard options for id: {id}, version: {version} and standard id type: {standardId.IdType}");
