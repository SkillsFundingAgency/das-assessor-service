CREATE PROCEDURE [dbo].[PopulateLearner_RemoveSupersededLearners]
AS
    ...
    -- and the data lock has been processed, this can be used to identify which learners have been duplicated and should be removed
    ...
    (
        SELECT 
            [Id] 
        FROM 
            [dbo].[Learner] l INNER JOIN [dbo].[ApprovalsExtract] ae 
