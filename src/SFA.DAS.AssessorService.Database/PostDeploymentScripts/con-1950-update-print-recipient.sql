...
BEGIN
	UPDATE [EMailTemplates] SET Recipients='xeroxsupport@funasset.com', UpdatedAt= GETDATE() WHERE TemplateName= 'PrintAssessorCoverLetters'
END
...
BEGIN
	INSERT INTO [EMailTemplates] ([TemplateName] ,[TemplateId] ,[Recipients] ,[CreatedAt] ,[DeletedAt] ,[UpdatedAt] ,[RecipientTemplate])
     VALUES ('PrintAssessorCoverLetters' ,'5b171b91-d406-402a-a651-081cce820acb' ,'xeroxsupport@funasset.com' , GETDATE() ,NULL ,NULL ,NULL)
END
