...
where certificateid in ( Select id from certificates where  createdby = 'API' and status = 'Draft' and  json_value(certificatedata,'$.EpaDetails.LatestEpaOutcome')  = 'Fail'  ) and action = 'Epa' and status = 'Draft'
