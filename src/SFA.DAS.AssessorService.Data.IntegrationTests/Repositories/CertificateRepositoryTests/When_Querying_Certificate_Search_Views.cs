...
namespace SFA.DAS.AssessorService.Data.IntegrationTests.Repositories.CertificateRepositoryTests
{
    ...
    {
        private static readonly DateTime DateOfBirth = new DateTime(1990, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        ...
        public void StandardCertificateSearchView_Returns_The_Searchable_Certificate()
        {
            ...
            using (var fixture = new CertificateSearchViewsFixture()
                .WithOrganisation("Test organisation", "EPA0001", 12345678, null)
                .WithSearchStandard("Test standard", "ST0001", 1001, "Test route")
                    ...
                    dateAwarded))
            {
                ...
                result.Should().BeEquivalentTo(new CertificateSearchViewResult
                {
        ...
        public void StandardCertificateSearchView_Does_Not_Return_An_Ineligible_Certificate(string status)
        {
            const long uln = 2000000001;
            ...
            {
                fixture.GetStandardCertificate(uln).Should().BeNull();
            }
        }
            ...
            : FixtureBase<CertificateSearchViewsFixture>, IDisposable
        {
            ...
            public CertificateSearchViewResult GetStandardCertificate(long uln)
            {
                return _databaseService.Get<CertificateSearchViewResult>(
                    $"SELECT * FROM [dbo].[StandardCertificateSearchView] WHERE [Uln] = {uln}");
            }

            public CertificateSearchViewResult GetFrameworkCertificate(long uln)
            {
                return _databaseService.Get<CertificateSearchViewResult>(
                    $"SELECT * FROM [dbo].[FrameworkCertificateSearchView] WHERE [Uln] = {uln}");
            }
        }
