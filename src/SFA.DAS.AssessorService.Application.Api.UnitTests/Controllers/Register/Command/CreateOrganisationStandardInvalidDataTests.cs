...
{
    [TestFixture]
    public class CreateOrganisationStandardInvalidDataTests
    {
        ...
        [Test]
        public void CreateOrganisationStandardBadRequestExceptionShouldReturnBadRequest()
        {
        ...
        {
            ((BadRequestObjectResult)_result).Value.Should().BeOfType<EpaOrganisationStandardResponse>();
        }
    }
}
