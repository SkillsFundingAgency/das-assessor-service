...
{
    public class WhenCourseOptionSetAndVersionNotSet : BatchEpaRequestValidatorTestBase
    {
        ...
        public async Task Arrange()
        {
            ...
            var request = Builder<BatchEpaRequest>.CreateNew()
                ...
                .With(i => i.Version = null)
                .With(i => i.StandardUId = null)
        ...
        public void ThenValidationResultShouldBeFalse()
        {
            ...
            _validationResult.Errors.First().ErrorMessage.Should().Be("Version must be set, when submitting a CourseOption value");
        }
    }
}