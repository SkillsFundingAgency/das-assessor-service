...
{
    public class WhenUpdatingDeletedCertificate : UpdateBatchEpaRequestValidatorTestBase
    {
        ...
        public async Task Arrange()
        {
            ...
            var request = Builder<UpdateBatchEpaRequest>.CreateNew()
                ...
                .With(i => i.EpaDetails = new EpaDetails { Epas = epas, EpaReference = "1234567890-98" })
                .Build();
