...
{
    public class WhenUpdatingSubmittedCertificate : UpdateBatchEpaRequestValidatorTestBase
    {
        ...
        public async Task Arrange()
        {
            ...
            var request = Builder<UpdateBatchEpaRequest>.CreateNew()
                ...
                .With(i => i.EpaDetails = new EpaDetails { Epas = epas, EpaReference = "9999999999-1" })
                .Build();
