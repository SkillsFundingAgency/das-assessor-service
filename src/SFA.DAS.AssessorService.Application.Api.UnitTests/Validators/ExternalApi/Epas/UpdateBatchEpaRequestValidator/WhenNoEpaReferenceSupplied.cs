...
{
    public class WhenNoEpaReferenceSupplied : UpdateBatchEpaRequestValidatorTestBase
    {
        ...
        public async Task Arrange()
        {
            ...
            var request = Builder<UpdateBatchEpaRequest>.CreateNew()
                ...
                .With(i => i.EpaDetails = new EpaDetails { Epas = epas, EpaReference = null })
                .Build();
        ...
        public void ThenValidationResultShouldBeFalse()
        {
            ...
            _validationResult.Errors.First().ErrorMessage.Should().Be("Provide EPA reference");
        }
    }
}
