...
{
    public class UpdateBatchCertificateRequestValidatorTestBase
    {
        private static Mock<ICertificateRepository> _CertificateRepositoryMock;

        protected static Api.Validators.Certificates.UpdateBatchCertificateRequestValidator Validator;
        ...
        protected static void Setup()
        {
            ...
            Validator = new Api.Validators.Certificates.UpdateBatchCertificateRequestValidator(stringLocalizerMock.Object, _CertificateRepositoryMock.Object);
        }
