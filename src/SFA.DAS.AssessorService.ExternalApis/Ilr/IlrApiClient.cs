...
namespace SFA.DAS.AssessorService.ExternalApis.Ilr
{
    public class IlrApiClient : IIlrApiClient
    {
        ...
        public IlrApiClient()
        {
            ...
            {
                new IlrRecord{Uln = "5407291429", Surname = "Hawkins", Firstname = "Karla", DateOfBirth = "15/04/2002", StandardId = "90", LearningStartDate = "08/09/2015", Provider = "City and Guilds"},
                new IlrRecord{Uln = "5407291429", Surname = "Hawkins", Firstname = "Karla", DateOfBirth = "15/04/2002", StandardId = "93", LearningStartDate = "12/08/2015", Provider = "City and Guilds"},
                new IlrRecord{Uln = "5633467851", Surname = "Taylor", Firstname = "Peter Taylor", DateOfBirth = "15/04/2002", StandardId = "205", LearningStartDate = "08/09/2015", Provider = "ACORN LEARNING SOLUTIONS LIMITED"},
