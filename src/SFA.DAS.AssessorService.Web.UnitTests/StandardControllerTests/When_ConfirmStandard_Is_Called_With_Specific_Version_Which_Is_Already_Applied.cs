        ...
        public async Task Then_ApplicationStatus_Of_Approved_Is_Returned()
        {
            ...
            _mockOrgApiClient
              ...
              .ReturnsAsync(new List<AppliedStandardVersion> {
                   ...
                   new AppliedStandardVersion { ApplicationId = Guid.NewGuid(), IFateReferenceNumber = "ST0001", Title = "Title 1", Version = "1.1", LarsCode = 1, EPAChanged = false, ApprovedStatus = ApprovedStatus.Approved},
